...
以下の情報をもとに、**簡潔で分かりやすい**試合観戦プランを日本語で提案してください。
...
# 指示
1. 現在地からスタジアムまでの簡潔な旅行プランを提案してください
2. スタジアム周辺のおすすめスポット1〜2箇所を含めてください
3. **文章は300文字以内**で、要点のみを簡潔にまとめてください
4. ギラヴァンツ北九州のサポーター向けの応援メッセージを添えてください

# 出力形式（必須）
必ずJSON形式で以下の構造で返してください：

{{
  "plan_text": "プランの簡潔な説明文（日本語、300文字以内、改行OK）",
  "route": {{
    "waypoints": [
      {{
        "name": "現在地",
